class Table {
    ...
    constructor(gameType:string, betDenominations:number[]=[5, 20, 50, 100]) {
      ...
      this.dealer = new Player('Dealer', 'dealer', this.gameType, 0);

      // プレイヤーを初期化(仮)
      this.players.push(new Player('AI1', 'ai', this.gameType, 100));
      this.players.push(new Player('AI2', 'ai', this.gameType, 100));
